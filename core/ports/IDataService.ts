...
export interface IDataService {
  ...
  markPartFileUploaded(quoteId: string, partId: string, fileType: "2d" | "3d", fileKey?: string, fileName?: string): Promise<void>;
  ...
  batchUpdate(quoteId: string, sets: Record<string, unknown>, arrayFilters?: Record<string, unknown>[]): Promise<void>;
}
